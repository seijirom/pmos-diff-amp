...
N -220 120 -220 160 {lab=#net5}
N -220 160 -200 160 {lab=#net5}
N -150 160 -130 160 {lab=#net6}
N -130 160 -90 160 {lab=#net6}
N 130 160 170 160 {lab=#net7}
N 170 160 190 160 {lab=#net7}
N 260 120 260 160 {lab=#net5}
N 240 160 260 160 {lab=#net5}
N -130 160 -130 180 {lab=#net6}
N 60 50 60 180 {lab=#net1}
N -60 180 60 180 {lab=#net1}
N 60 180 100 180 {lab=#net1}
N 260 160 260 190 {lab=#net5}
N -260 100 -260 200 {lab=#net4}
N -380 130 -380 210 {lab=GND}
N -130 230 -130 240 {lab=#net7}
N 170 160 170 240 {lab=#net7}
N -130 240 170 240 {lab=#net7}
...
N -380 260 -380 340 {lab=#net8}
N -260 250 -260 340 {lab=#net8}
N -380 340 -260 340 {lab=#net8}
N -60 320 -60 340 {lab=#net8}
N -260 340 -60 340 {lab=#net8}
N 100 320 100 340 {lab=#net8}
N -60 340 100 340 {lab=#net8}
...
C {voltage.sym} 260 180 0 0 {name=Vicm value=2.7}
